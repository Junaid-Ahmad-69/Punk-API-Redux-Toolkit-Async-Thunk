...
const ViewBeer = () => {
    ...
    const handleAddToCart = (item: BeersList) => {
        dispatch(addToCart(item as CartListItems));
    }
    ...
    return (
        <div className="bg-gray-100 rounded-md min-h-screen">
            <div className="container mx-auto px-12 py-16 h-full">
                <div className="flex flex-wrap lg:flex-nowrap gap-10 -mx-4">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        <h2 className="text-3xl font-bold mb-2">{currentProduct.name} ({currentProduct.volume.value} {currentProduct.volume.unit})</h2>
                        <p className="text-gray-600 mb-8">{currentProduct.tagline}</p>
                        ...
                        <div className="flex items-center gap-8 mb-4">
                            <div className="flex items-start flex-col gap-2">
                                ...
                                <span className="ml-6 text-gray-600">{currentProduct.target_fg} SI</span>
                            </div>
                            <div className="flex items-start flex-col gap-2">
                                <h5 className="flex items-center gap-2"><Target className="text-red-500"
                                                                                size={16}/> Target Original Gravity
                                </h5>
                                <span className="ml-6 text-gray-600">{currentProduct.target_og} SI</span>
                            </div>
                        </div>
                        <div>
                        ...
                        <div className="flex space-x-4 mb-6">
                            ...
                            {existingWishList ?
                                (
                                    <Button
                                        onClick={() => handleRemoveItem(currentProduct.id)}
                            ...
                            <div className="grid lg:grid-cols-2 md:grid-cols-1">
                                <div>
                                    ...
                                    <ul className="list-disc list-inside text-gray-700 mb-8">
                                        {currentProduct.ingredients.hops.map((hop, index) => (
                                            <li key={index}
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside text-gray-700 mb-8">
                                        {currentProduct.ingredients.malt.map((malt, index) => (
                                            <li key={index}
                                ...
                                <div>
                                    ...
                                    <p>{currentProduct.ingredients.yeast}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center justify-start gap-2">
                        {currentProduct.food_pairing.map((food, index) => <BadgeItem key={index}>{food}</BadgeItem>)}
                    </div>
                </div>
                <div className="mb-6">
                    ...
                    <div>
                        <div className="flex items-center justify-start gap-2 mb-4">
                            ...
                            <span className="flex items-center"><Thermometer size={18}
                                                                             className="text-red-400"/>{currentProduct.method.fermentation.temp.value}
                                <sup>o</sup> {currentProduct.method.fermentation.temp.unit}</span>
                        </div>
                        <div className="flex items-center justify-start gap-2">
                            <h6>Mash Temperature:</h6>
                            {currentProduct.method.mash_temp.map((mash, index) =>
